...
public class OrderController {
    ...
    public ResponseEntity<String> createStripeClientSecret(@RequestBody StripePaymentDto stripePaymentDto) {
        ...
        try {
            ...
            System.out.println("Stripe service failed (likely invalid API key). Returning mock secret: " + e.getMessage());
            return new ResponseEntity<>("mock_secret_test_key_" + System.currentTimeMillis(), HttpStatus.CREATED);
        }
    }
